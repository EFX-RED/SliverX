...
const (
	...
	SliverRPC_HelloWorld_FullMethodName                       = "/rpcpb.SliverRPC/HelloWorld"
	SliverRPC_ModifyHostsFile_FullMethodName                  = "/rpcpb.SliverRPC/ModifyHostsFile"
...
type SliverRPCClient interface {
	...
	HelloWorld(ctx context.Context, in *sliverpb.HelloWorldReq, opts ...grpc.CallOption) (*sliverpb.HelloWorld, error)
	ModifyHostsFile(ctx context.Context, in *sliverpb.ModifyHostsFileReq, opts ...grpc.CallOption) (*sliverpb.ModifyHostsFile, error)
	// *** Sessions ***
...
func (c *sliverRPCClient) HelloWorld(ctx context.Context, in *sliverpb.HelloWorldReq, opts ...grpc.CallOption) (*sliverpb.HelloWorld, error) {
	out := new(sliverpb.HelloWorld)
	err := c.cc.Invoke(ctx, SliverRPC_HelloWorld_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sliverRPCClient) ModifyHostsFile(ctx context.Context, in *sliverpb.ModifyHostsFileReq, opts ...grpc.CallOption) (*sliverpb.ModifyHostsFile, error) {
	out := new(sliverpb.ModifyHostsFile)
	err := c.cc.Invoke(ctx, SliverRPC_ModifyHostsFile_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SliverRPCServer interface {
	...
	HelloWorld(context.Context, *sliverpb.HelloWorldReq) (*sliverpb.HelloWorld, error)
	ModifyHostsFile(context.Context, *sliverpb.ModifyHostsFileReq) (*sliverpb.ModifyHostsFile, error)
	// *** Sessions ***
...
func (UnimplementedSliverRPCServer) HelloWorld(context.Context, *sliverpb.HelloWorldReq) (*sliverpb.HelloWorld, error) {
	return nil, status.Errorf(codes.Unimplemented, "method HelloWorld not implemented")
}
func (UnimplementedSliverRPCServer) ModifyHostsFile(context.Context, *sliverpb.ModifyHostsFileReq) (*sliverpb.ModifyHostsFile, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ModifyHostsFile not implemented")
}
...
func _SliverRPC_HelloWorld_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(sliverpb.HelloWorldReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SliverRPCServer).HelloWorld(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SliverRPC_HelloWorld_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SliverRPCServer).HelloWorld(ctx, req.(*sliverpb.HelloWorldReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _SliverRPC_ModifyHostsFile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(sliverpb.ModifyHostsFileReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SliverRPCServer).ModifyHostsFile(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SliverRPC_ModifyHostsFile_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SliverRPCServer).ModifyHostsFile(ctx, req.(*sliverpb.ModifyHostsFileReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SliverRPC_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _SliverRPC_HelloWorld_Handler,
		},
		{
			MethodName: "ModifyHostsFile",
			Handler:    _SliverRPC_ModifyHostsFile_Handler,
		},
		{
